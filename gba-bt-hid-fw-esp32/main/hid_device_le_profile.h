...
#ifndef GBA_BT_HID_FW_SP32_HID_DEVICE_LE_PROFILE_H
#define GBA_BT_HID_FW_SP32_HID_DEVICE_LE_PROFILE_H
...
enum {
    BAS_IDX_SVC,    // Battery Service index

    BAS_IDX_BATT_LVL_CHAR,  // Battery Service Battery Level Characteristic index
    BAS_IDX_BATT_LVL_VAL,   // Battery Service Battery Level Value index
    BAS_IDX_BATT_LVL_NTF_CFG,   // Battery Service Battery Level notifications configuration (CCC) index
    BAS_IDX_BATT_LVL_PRES_FMT,  // Battery Service Battery Level presentation format

    BAS_IDX_NB, // Number of table elements
};


/// HID Service Attributes Indexes
///
/// HID Control Point: The HID Control Point characteristic allows the Report Host to signal the HID Device that the
///                    Report host is entering or exiting a power saving mode known as Suspend Mode.
///
/// Report Map: Basically the HID Descriptor
///
/// Protocol Mode: characteristic allows reading and writing of the protocol mode of the HID Service,
///                and to set the desired protocol mode.
/// Boot Keyboard Input Report: characteristic is used to transfer HID Service data representing keyboard keystrokes
///                             between a HID Service corresponding to a HID Device operating in Boot Protocol Mode as a
///                             keyboard and a Boot Host.
enum {
    HIDD_LE_IDX_SVC,    // HIDD LE Service index

    HIDD_LE_IDX_INCL_SVC,   // HIDD LE Service Included Services index

    HIDD_LE_IDX_HID_INFO_CHAR,  // HIDD LE Service HID Info Characteristic index
    HIDD_LE_IDX_HID_INFO_VAL,   // HIDD LE Service HID Info Value index

    HIDD_LE_IDX_HID_CTNL_PT_CHAR, // HIDD LE Service HID Control Point Characteristic index
    HIDD_LE_IDX_HID_CTNL_PT_VAL,  // HIDD LE Service HID Control Point Value index

    HIDD_LE_IDX_REPORT_MAP_CHAR, // HIDD LE Service HID Report Map Characteristic index
    HIDD_LE_IDX_REPORT_MAP_VAL, // HIDD LE Service HID Report Map Value index
    HIDD_LE_IDX_REPORT_MAP_EXT_REP_REF, // HIDD LE Service HID Report Map External Report Reference index

    HIDD_LE_IDX_PROTO_MODE_CHAR, // HIDD LE Service HID Protocol Mode Characteristic index
    HIDD_LE_IDX_PROTO_MODE_VAL, // HIDD LE Service HID Protocol Mode Value index

    HIDD_LE_IDX_REPORT_MOUSE_IN_CHAR,   // HIDD LE Service HID Mouse Report Input Characteristic index
    HIDD_LE_IDX_REPORT_MOUSE_IN_VAL, // HIDD LE Service HID Mouse Report Input Value index
    HIDD_LE_IDX_REPORT_MOUSE_IN_CCC, // HIDD LE Service HID Mouse Report Input Client Characteristic Configuation index
    HIDD_LE_IDX_REPORT_MOUSE_REP_REF, // HIDD LE Service HID Mouse Report Reference index

    HIDD_LE_IDX_REPORT_KEY_IN_CHAR, // HIDD LE Service Report Keyboard Input Characteristic Index
    HIDD_LE_IDX_REPORT_KEY_IN_VAL, // HIDD LE Service Report Keyboard Input Value Index
    HIDD_LE_IDX_REPORT_KEY_IN_CCC, // HIDD LE Service Report Keyboard Input Client Characteristic Configuation Index
    HIDD_LE_IDX_REPORT_KEY_IN_REP_REF, // HIDD LE Service Report Keyboard Report Reference index

    HIDD_LE_IDX_REPORT_LED_OUT_CHAR, // HIDD LE Service HID Mouse Report Output Characteristic index
    HIDD_LE_IDX_REPORT_LED_OUT_VAL, // HIDD LE Service HID Mouse Report Output Value index
    HIDD_LE_IDX_REPORT_LED_OUT_REP_REF, // HIDD LE Service HID Mouse Report Reference index
...
#endif //GBA_BT_HID_FW_SP32_HID_DEVICE_LE_PROFILE_H
