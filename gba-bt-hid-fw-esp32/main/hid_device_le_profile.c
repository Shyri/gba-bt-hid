...
//        0x81, 0x03,          //     INPUT = Cnst,Var,Abs
        ...
        0x81, 0x42,        //   Input (Data, Variable, Absolute) - Button states
        0x65, 0x00,        //   Unit (None)
...
/// Full Battery Service  Database Description - Used to add attributes into the database
...
static esp_gatts_attr_db_t hidd_le_gatt_db[HIDD_LE_IDX_NB] =
        {
                ...
                // HID Service Included Services Declaration
